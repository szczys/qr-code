...
#test message to find which charset it should use
charSet = whichCharSet(message)
if (charSet == None): raise Exception("Message contains unsupported characters")

#figure out the smallest possible symbol to use for this message:
